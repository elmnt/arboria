    ...
    <div class="col-6">
      ...
      <div class="product__imgs">
        ...
        <picture class="fit">
          ...
          <source srcset="<?php echo $page->images()->filterBy('extension', 'jpg')->first()->resize(400)->url() ?>" media="(min-width: 100px)">
          <img srcset="<?php echo $page->images()->filterBy('extension', 'jpg')->first()->resize(400)->url() ?>" alt="<?php echo $page->title()->html() ?>">
        </picture>
        </a>
